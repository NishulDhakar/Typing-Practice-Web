...
[![Live Demo](https://img.shields.io/badge/LIVE_DEMO-VIEW_SITE-2ea44f?style=for-the-badge)](https://typing-game-lyart.vercel.app/)
...
- Beginners can practice basics
- Pros can challenge their limits
...
Experience the thrill of typing at [Type Master Challenge](https://typing-game-lyart.vercel.app/)

## 🛠️ Quick Start

```bash
# Clone this typing paradise
git clone https://github.com/NishulDhakar/Typing-Game.git

# Enter the arena
cd Typing-Game

# Equip your weapons (dependencies)
npm install
...
### ⌨️ Typing Challenge
- Practice with curated text samples
